...
export const traitsPage: Loc<TraitsStrings> = {
  en: {
    ...
    cross: {
      ...
      links: [
        ...
        { label: "reroll calculator", path: "/trait-reroll/" },
        { label: "working codes", path: "/" },
      ],
      between: [", plan their evolutions in the ", ", check the odds in the ", ", then grab "],
  ...
  es: {
    ...
    cross: {
      ...
      links: [
        ...
        { label: "calculadora de rerolls", path: "/trait-reroll/" },
        { label: "códigos activos", path: "/" },
      ],
      between: [", planea sus evoluciones en el ", ", mira las probabilidades en la ", " y consigue "],
  ...
  pt: {
    ...
    cross: {
      ...
      between: [", planeje as evoluções no ", ", confira as chances na ", " e pegue "],
  ...
  ru: {
    ...
    cross: {
      ...
      links: [
        ...
        { label: "калькулятор рероллов", path: "/trait-reroll/" },
        { label: "рабочих кодов", path: "/" },
      ],
      between: [", спланируйте эволюции в ", ", проверьте шансы в ", ", затем заберите "],
