  ...
  ru: {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Встречаются два написания: «аниме экспедиция» (перевод) и «аниме экспедишн» (транслитерация). Это одна и та же игра — Anime Expeditions на Roblox, и коды у неё одни. Оба запроса ведут сюда, поэтому список ниже подходит независимо от того, как вы пишете название.",
      },
    ],
    menu: {
